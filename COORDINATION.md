...
| T-018 | Write docs/TEST_PLAN.md — acceptance checklist per feature (offline queue, image compression, store JSON, driver auth, HACCP flag) | @code | IN-PROGRESS | One section per feature with explicit pass/fail criteria. Source of truth for T-019/T-020/T-021. |
